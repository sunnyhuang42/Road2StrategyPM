...
决策质量也很区分产品经理功力。上如现在最需要解决的问题是什么、项目目标到底是什么，下到这个支付时限到底要不要调整，如何调整。

大的决策上面说过一些，这回主要说说小决策，还是支付时限的例子。调研结果出来了，什么样时限的都有，且各家差异不小，我们到底要不要改？要做这个决策，需要考虑的问题不少：
...
归纳法只能基于已知信息做决策，但演绎法和基于模型推演出可能的情况，未雨绸缪。
