...
三节课网站整体的信息架构，暂时没碰到印象深刻之处。课程呈现方式，和开智类似，也是线性引导、解锁学习。但呈现方式挺友好，不会觉得太碎片。无 App ，但可以在微信服务号上查看课程内容。
...
3. 课程主页面左边能直接查看（滑出效果）整个课程目录、右边能查看课程作业目录，不必跳转来跳转去才能看到，给用户全局感和掌控感，不易迷失。
